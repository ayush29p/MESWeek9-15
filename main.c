...
// ///////////////////////////////////////////////////////////////////////
// New Prototypes for tick and button handlers
...
//
// If this function does not exist, the board will crash when the button is
// pressed if it is being initialized to use interrupts for the button instead
// of GPIO Mode
void EXTI0_IRQHandler(void)
{
    // Call your button handler hook function
    aprajapati3982_btn();
...
int main(int argc, char **argv)
{
  ...
  uint8_t accelRc = BSP_ACCELERO_Init();
...
void SysTick_Handler(void)
{
    ...
    // Call aprajapati3982_tick
    // comment out if things go really bad
    aprajapati3982_tick();
}
